...
class _ViewUserState extends State<ViewUser> {
  final Set<int> favoriteUsers = {}; // Store favorite users by index
  String searchQuery = "";
  String sortBy = "fullName"; // Default sorting field
  ...
  void _deleteUser(int index) async {
    ...
    if (confirmDelete) {
      int userId = widget.userDetail[index]['id'];
  ...
  List<Map<String, dynamic>> _filteredUsers() {
    return widget.userDetail.where((user) {
