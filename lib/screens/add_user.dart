...
class _AddUserState extends State<AddUser> {
  ...
  void _saveUser() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (widget.existingUser == null) {
        ...
        await DatabaseHelper().updateUser(user, widget.existingUser!['id']);
      }
    ...
    return Form(
      ...
      child: Column(
        children: [
          ...
          _buildCityDropdown(),
          _buildHobbiesField(),
          // Only show password fields if it's a new user (widget.existingUser is null)
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        keyboardType: email
            ...
            : number
            ? TextInputType.phone  // Use phone keyboard here for mobile number
            : TextInputType.text,
        inputFormatters: number
            ? [FilteringTextInputFormatter.digitsOnly] // Allow only digits for mobile number
            : [],
      ...
      child: TextFormField(
        ...
        onTap: () async {
          DateTime? picked = await showDatePicker(
            context: context,
            initialDate: DateTime.now().subtract(const Duration(days: 6570)), // 18+ years old
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            hint: Text("Select Gender"),  // Add the hint here
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                    onPressed: _addHobby,
                    icon: const Icon(Icons.add, color: Colors.pink),  // Add icon inside text field
                  ),
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(20)),
                  filled: true,
                  fillColor: Colors.white,
  ...
  Widget _buildPasswordField(TextEditingController controller, String label, bool isPasswordField) {
    if (widget.existingUser != null && !isPasswordField) {
      // Don't show the confirm password field if editing an existing user
